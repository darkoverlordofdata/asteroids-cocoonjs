...
(function() {
  'use strict';
  var AbstractGame, AnimationSystem, AsteroidDeathView, AsteroidView, Asteroids, AudioSystem, BulletAgeSystem, BulletView, CollisionSystem, Components, DeathThroesSystem, Dot, Entities, ExplodeAsteroid, ExplodeShip, FacebookLeaderboard, FixedPhysicsSystem, GameManager, GameSettings, GunControlSystem, HudSystem, HudView, KeyPoll, LocalLeaderboard, MersenneTwister, Nodes, Point, RenderSystem, ShipControlSystem, ShootGun, SmoothPhysicsSystem, Sound, SpaceshipDeathView, SpaceshipView, SystemPriorities, WaitForStartSystem, WaitForStartView, getKey,
  ...
  getKey = function(fbAppId, fbUserId) {
    ...
    fbUserId = '' + fbUserId;
    result = [];
    for (i = _i = 0, _ref = Math.max(fbAppId.length, fbUserId.length); 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
  ...
  SmoothPhysicsSystem = (function(_super) {
    ...
    function SmoothPhysicsSystem(parent) {
      ...
      this.update = __bind(this.update, this);
      this.removeFromEngine = __bind(this.removeFromEngine, this);
      this.addToEngine = __bind(this.addToEngine, this);
      this.width = parent.width;
      this.height = parent.height;
      this.world = parent.world;
      this.game = parent.game;
  ...
  CollisionSystem = (function(_super) {
    ...
    CollisionSystem.prototype.update = function(time) {
      var a, b, body, points, position, radius, type, _ref;
      ...
      if (node && node.state.playing) {
        if (this.spaceships.empty) {
          if (node.state.lives > 0) {
            ...
            this.parent.score(node.state.hits);
  ...
  AbstractGame = (function() {
    ...
    AbstractGame.prototype.name = '';

    AbstractGame.prototype.game = null;

    AbstractGame.prototype.height = window.innerHeight;

    AbstractGame.prototype.width = window.innerWidth;

    AbstractGame.prototype.scale = window.devicePixelRatio;
    ...
    function AbstractGame(name, properties) {
      this.name = name;
      ...
      this.initializeDb(this.name, this.properties);
    }
    ...
    AbstractGame.prototype.init = function() {
    ...
    AbstractGame.prototype.preload = function() {};
    ...
    AbstractGame.prototype.get = function(prop) {
      var n;
      n = 'get' + ucfirst(prop);
      if (this[n] != null) {
        return this[n]();
    ...
    AbstractGame.prototype.set = function(prop, value) {
      var n;
      n = 'set' + ucfirst(prop);
      if (this[n] != null) {
        this[n](value);
    ...
    AbstractGame.prototype.initializeDb = function(name, properties) {
      var isNew, key, val;
  ...
  GameSettings = (function() {
    GameSettings.prototype.parent = null;

    GameSettings.prototype.game = null;

    GameSettings.prototype.faderBitmap = null;

    GameSettings.prototype.faderSprite = null;

    GameSettings.prototype.optBgd = '';

    GameSettings.prototype.height = 0;

    GameSettings.prototype.width = 0;

    function GameSettings(parent) {
      this.parent = parent;
      ...
      this.height = this.parent.height;
      this.width = this.parent.width;
      this.optBgd = this.parent.optBgd;
    ...
    GameSettings.prototype.onSettings = function() {
    ...
    GameSettings.prototype.pause = function(next) {
      if (next != null) {
        this.faderSprite = null;
        this.parent.physics.enabled = false;
        this.fade(next);
      } else {
        this.fade((function(_this) {
          return function() {
            return _this.parent.physics.enabled = true;
          };
        })(this));
      }
    };
    ...
    GameSettings.prototype.getFaderSprite = function() {
    ...
    GameSettings.prototype.fade = function(next) {
      var fader, sprite;
  ...
  FacebookLeaderboard = (function(_super) {
    __extends(FacebookLeaderboard, _super);

    FacebookLeaderboard.prototype.name = '';

    FacebookLeaderboard.prototype.title = '';

    FacebookLeaderboard.prototype.fb = null;

    FacebookLeaderboard.prototype.fbButton = null;

    FacebookLeaderboard.prototype.fbAppId = '';

    FacebookLeaderboard.prototype.fbUserID = '';

    FacebookLeaderboard.prototype.fbUserName = '';

    FacebookLeaderboard.prototype.fbStatus = 0;

    function FacebookLeaderboard(parent, fbAppId, name, title) {
      this.parent = parent;
      this.fbAppId = fbAppId;
      this.name = name;
      this.title = title;
      this.score = __bind(this.score, this);
      this.showLocal = __bind(this.showLocal, this);
      this.showServer = __bind(this.showServer, this);
      this.show = __bind(this.show, this);
      this.onLogin = __bind(this.onLogin, this);
      this.onLeaderboard = __bind(this.onLeaderboard, this);
      FacebookLeaderboard.__super__.constructor.call(this, this.parent);
      this.fb = Cocoon.Social.Facebook;
      this.fb.init({
        appId: this.fbAppId
      });
      console.log('player', this.parent.get('player'));
      console.log('userId', this.parent.get('userId'));
      console.log('leaderboard', this.parent.get('leaderboard'));
      if (this.parent.get('leaderboard') === 'on') {
        this.fb.getLoginStatus((function(_this) {
    ...
    FacebookLeaderboard.prototype.onLeaderboard = function() {
      this.pause((function(_this) {
        return function() {
          return _this.show(_this.pause);
        };
      })(this));
    };

    FacebookLeaderboard.prototype.onLogin = function() {
      return this.pause((function(_this) {
        return function() {
          return _this.fb.login(function(response) {
            if (response.authResponse) {
              return _this.fb.api('/me', function(response) {
                ...
                if (response.error) {
                  ...
                  _this.fbStatus = 1;
                  _this.fbUserID = response.id;
                  _this.fbUserName = response.name;
                  if (_this.parent.get('player') === '' || _this.parent.get('player') === _this.fbUserName) {
                    _this.parent.set('player', _this.fbUserName);
                    _this.parent.set('userId', _this.fbUserID);
                    _this.parent.set('leaderboard', 'on');
                    return Cocoon.App.loadInTheWebView("settings.html");
                  }
                }
              });
    ...
    FacebookLeaderboard.prototype.show = function(pause) {
      var xhr;
      if (pause == null) {
        pause = function() {};
      }
        ...
        xhr.onreadystatechange = (function(_this) {
          return function() {
            ...
            if (xhr.readyState === 4 && xhr.status === 200) {
              ...
              return _this.showServer(response);
            }
          };
        })(this);
        xhr.open('get', HOST + '/leaderboard/' + this.name + '/' + this.get('player'), true);
        xhr.setRequestHeader('Content-Type', 'application/json; charset=UTF-8');
        xhr.send();
      } else {
        this.showLocal(Db.queryAll('leaderboard', {
          limit: 10,
          sort: [['score', 'DESC']]
        }), pause);
      }
    ...
    FacebookLeaderboard.prototype.showServer = function(data, pause) {
      var big, board, button, dialog, label, normal, row, title, y, _i, _len;
      ...
      title = new Phaser.Text(this.game, this.width / 2, 20, this.title + ' - ' + this.get('player'), big);
      title.anchor.x = 0.5;
      board.add(title);
      board.add(new Phaser.Text(this.game, 200, 80, '##', normal));
      board.add(new Phaser.Text(this.game, 300, 80, 'Name', normal));
      board.add(new Phaser.Text(this.game, 500, 80, 'Score', normal));
      board.add(new Phaser.Text(this.game, 200, 100, '--', normal));
      board.add(new Phaser.Text(this.game, 300, 100, '--------', normal));
      board.add(new Phaser.Text(this.game, 500, 100, '--------', normal));
      y = 120;
      for (_i = 0, _len = data.length; _i < _len; _i++) {
        row = data[_i];
        board.add(new Phaser.Text(this.game, 200, y, row.rank, normal));
        board.add(new Phaser.Text(this.game, 300, y, row.member, normal));
        board.add(new Phaser.Text(this.game, 500, y, row.score, normal));
        y += 20;
      }
    ...
    FacebookLeaderboard.prototype.showLocal = function(data, pause) {
      ...
      title = new Phaser.Text(this.game, this.width / 2, 20, this.title, big);
      title.anchor.x = 0.5;
      board.add(title);
    ...
    FacebookLeaderboard.prototype.score = function(score) {
      var dd, form, mm, today, xhr, yyyy, yyyymmdd;
      today = new Date();
      ...
      if (this.fbStatus === 0) {
        ...
        form = {
          key: getKey(this.fbAppId, this.fbUserID),
          dt: Date.now(),
          id: this.name,
          title: this.title,
          appId: this.fbAppId,
          ...
          date: yyyymmdd,
          score: score,
          userName: this.parent.get('player')
        };
        xhr = new XMLHttpRequest();
    ...
    return FacebookLeaderboard;

  })(GameSettings);

  LocalLeaderboard = (function(_super) {
    __extends(LocalLeaderboard, _super);

    LocalLeaderboard.prototype.name = '';

    LocalLeaderboard.prototype.title = '';

    LocalLeaderboard.prototype.fb = null;

    LocalLeaderboard.prototype.fbButton = null;

    LocalLeaderboard.prototype.fbAppId = '';

    LocalLeaderboard.prototype.fbUserID = '';

    LocalLeaderboard.prototype.fbUserName = '';

    LocalLeaderboard.prototype.fbStatus = 0;

    function LocalLeaderboard(parent, name, title) {
      this.parent = parent;
      this.name = name;
      this.title = title;
      this.score = __bind(this.score, this);
      ...
      this.show = __bind(this.show, this);
      this.onLeaderboard = __bind(this.onLeaderboard, this);
      LocalLeaderboard.__super__.constructor.call(this, this.parent);
      this.game.add.button(this.width - 50, 125, 'leaderboard', this.onLeaderboard);
    }
    ...
    LocalLeaderboard.prototype.onLeaderboard = function() {
      this.pause((function(_this) {
        return function() {
          return _this.show(_this.pause);
        };
    ...
    LocalLeaderboard.prototype.show = function(pause) {
      if (pause == null) {
        pause = function() {};
      }
      this.showLocal(Db.queryAll('leaderboard', {
    ...
    LocalLeaderboard.prototype.showLocal = function(data, pause) {
      var big, board, button, dialog, label, mmddyyyy, normal, row, title, y, _i, _len;
      board = this.game.add.group();
      dialog = new Phaser.Sprite(this.game, 0, 0, "dialog-" + this.optBgd);
      dialog.width = this.width;
    ...
    LocalLeaderboard.prototype.score = function(score) {
      var dd, mm, today, yyyy, yyyymmdd;
      today = new Date();
      mm = (today.getMonth() + 1).toString();
      if (mm.length === 1) {
        mm = '0' + mm;
  ...
  Asteroids = (function(_super) {
    ...
    Asteroids.prototype.leaderboard = null;

    Asteroids.prototype.bgdColor = 0x6A5ACD;

    Asteroids.prototype.playMusic = true;

    Asteroids.prototype.playSfx = true;

    Asteroids.prototype.optBgd = 'blue';

    Asteroids.prototype.properties = {
      profiler: 'on',
      leaderboard: 'off',
      player: '',
      userId: '',
    ...
    function Asteroids() {
      ...
      this.getFbUserName = __bind(this.getFbUserName, this);
      this.getFbUserID = __bind(this.getFbUserID, this);
      this.getFbAppId = __bind(this.getFbAppId, this);
      this.score = __bind(this.score, this);
      this.resume = __bind(this.resume, this);
      this.create = __bind(this.create, this);
      this.preload = __bind(this.preload, this);
      Asteroids.__super__.constructor.call(this, 'asteroids', this.properties);
    }
    ...
    Asteroids.prototype.create = function() {
      ...
      if (useBox2dPlugin) {
        this.leaderboard = new LocalLeaderboard(this, 'asteroids', 'Asteroid Simulator');
      } else {
        this.leaderboard = new FacebookLeaderboard(this, '887669707958104', 'asteroids', 'Asteroid Simulator');
      }
      ...
      this.ash = this.game.plugins.add(ash.ext.PhaserEngine, Nodes, Components);
    ...
    Asteroids.prototype.resume = function() {
      this.leaderboard.pause();
    };

    Asteroids.prototype.score = function(score) {
      this.leaderboard.score(score);
    };
    ...
    Asteroids.prototype.getFbAppId = function() {
      return this.leaderboard.fbAppId;
    };

    Asteroids.prototype.getFbUserID = function() {
      return this.leaderboard.fbUserID;
    };

    Asteroids.prototype.getFbUserName = function() {
      return this.leaderboard.fbUserName;
    };
