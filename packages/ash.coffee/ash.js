...
(function() {
  ...
  ash.signals.Signal0 = Signal0 = (function(superClass) {
  ...
  ash.signals.Signal1 = Signal1 = (function(superClass) {
  ...
  ash.signals.Signal2 = Signal2 = (function(superClass) {
  ...
  ash.signals.Signal3 = Signal3 = (function(superClass) {
  ...
  ash.core.NodePool = NodePool = (function() {
    ...
    function NodePool(nodeClass1, components) {
      this.nodeClass = nodeClass1;
  ...
  ash.core.ComponentMatchingFamily = ComponentMatchingFamily = (function() {
    ...
    function ComponentMatchingFamily(nodeClass1, engine1) {
      this.nodeClass = nodeClass1;
      this.engine = engine1;
      this.releaseNodePoolCache = bind(this.releaseNodePoolCache, this);
      this.init();
    }
    ...
    ComponentMatchingFamily.prototype.addIfMatch = function(entity) {
      var componentClass, name, node, ref, ref1;
      if (this.entities[entity.name] == null) {
        ref = this.nodeClass.components;
        for (name in ref) {
          componentClass = ref[name];
        ...
        node.entity = entity;
        ref1 = this.nodeClass.components;
        for (name in ref1) {
          componentClass = ref1[name];
  ...
  ash.fsm.StateComponentMapping = StateComponentMapping = (function() {
    ...
    function StateComponentMapping(creatingState1, type) {
      this.creatingState = creatingState1;
      this.componentType = type;
      this.withType(type);
    }
  ...
  ash.fsm.EngineStateMachine = EngineStateMachine = (function() {
    ...
    EngineStateMachine.prototype.changeState = function(name) {
      var each, id, newState, other, provider, ref, ref1, toAdd;
      ...
      if (currentState) {
        ref1 = this.currentState.providers;
        for (each in ref1) {
          provider = ref1[each];
          id = provider.identifier;
          other = toAdd[id];
  ...
  ash.tick.FrameTickProvider = FrameTickProvider = (function(superClass) {
  ...
  ash.tools.ComponentPool = ComponentPool = (function() {
    ...
    getPool = function(componentClass) {
      var ref;
      if ((ref = componentClass.name, indexOf.call(pools, ref) >= 0)) {
  ...
  ash.tools.ListIteratingSystem = ListIteratingSystem = (function(superClass) {
